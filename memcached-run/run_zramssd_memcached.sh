...
# sudo ./bin/ycsb load memcached -s -P workloads/workload_memcached_hotspot  -p "memcached.hosts=127.0.0.1" -threads 4 -p "memcached.host=127.0.0.1" > $scriptdir/outputLoad.txt 2>&1
